...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		MO(2),   KC_A,       KC_S,     KC_D,     KC_F,    KC_B,  KC_N,     KC_M,  KC_COMM,  KC_DOT,  MO(2),    LM(1,     MOD_RSFT),
		LM(1,    MOD_LSFT),  KC_Z,     KC_X,     KC_C,    KC_V,  KC_SPC),
 	//base + shift
	KEYMAP(
		KC_MPLY,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,   _______,  _______,  _______,  _______,  _______,  KC_DEL,
