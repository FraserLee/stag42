...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //layer 1 (momentary)
    KEYMAP(
        KC_ESC,      KC_GRV,      S(KC_GRV),  S(KC_COMMA),  S(KC_DOT),   S(KC_5),  S(KC_6),  S(KC_7),     S(KC_8),     S(KC_9),  S(KC_0),    KC_BSPC,
        S(KC_BSLS),  S(KC_1),     S(KC_2),    S(KC_3),      S(KC_4),     KC_SCLN,  KC_EQL,   KC_MINS,     S(KC_QUOT),  KC_QUOT,  S(KC_EQL),  _______,
        _______,     S(KC_SLSH),  KC_DOT,     KC_COMMA,     S(KC_SCLN),  KC_LBRC,  KC_RBRC,  S(KC_MINS),  KC_LGUI,     KC_LALT,  KC_LCTL,    _______,
        _______,     KC_BSLS,     KC_SLSH,    S(KC_LBRC),   S(KC_RBRC),  KC_SPC
    ),
    //layer 2 (momentary)
    KEYMAP(
        ...
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_B,   KC_N,   KC_DOT,  KC_LGUI,  KC_LALT,  KC_LCTL,  _______,
        _______,  KC_F11,   KC_F12,   KC_C,     KC_0,     KC_SPC
    )
};
