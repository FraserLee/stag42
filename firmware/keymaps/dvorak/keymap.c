...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        _______,     S(KC_SLSH),  KC_DOT,     KC_COMMA,     S(KC_SCLN),  KC_LBRC,  KC_RBRC,  S(KC_MINS),  KC_W,        KC_V,     KC_Z,       KC_ENT,
    ...
    KEYMAP(
        ...
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_X,   KC_B,   KC_DOT,  KC_W,   KC_V,   KC_Z,    KC_ENT,
        _______,  KC_F11,   KC_F12,   KC_J,     KC_0,     KC_SPC
    )
};
